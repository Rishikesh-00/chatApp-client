  ...
  return (
    <div className="relative md:w-[35vw] lg:w-[30vw] xl:w-[20vw] bg-[#1b1c24] border-r-2 border-[#2f303b]   w-full " >
      ...
      <div className="my-5">
        ...
        <div className="mx-h-[38vh] overflow-y-auto scrollbar-hidden  ">
...
const Logo = () => {
  return (
    <div className="flex p-5 text-white justify-start items-center gap-2">
      <svg
        id="logo-38"
        width="78"
        height="32"
      ...
      <span className="text-3xl font-semibold ">Hyy Chat</span>
    </div>
  );
};
