...
function NewDM() {
    ...
    const selectNewContact = (contact) => {
        ...
        setSearchedContacts([]);  // Reset search after selecting a contact
    };
    ...
    return (
        <div className="text-white">
            ...
            <Dialog open={openNewContactModel} onOpenChange={(isOpen) => setOpenNewContactModel(isOpen)}>
                        ...
                        <div className="flex flex-col gap-5">
                            {searchedContacts.map(contact => (
                                <div
                                    ...
                                    onClick={() => selectNewContact(contact)} // Wrap in an arrow function
                                >
                                    <div className="w-12 h-12 relative">
                                        <Avatar className="h-12 w-12 rounded-full border overflow-hidden">
                                            {contact.image ? (
                                                ...
                                                <div
                                                    className={`uppercase h-12 w-12 border-[1px] text-lg flex justify-center items-center rounded-full ${getColor(contact.getColor)}`}
                                                >
